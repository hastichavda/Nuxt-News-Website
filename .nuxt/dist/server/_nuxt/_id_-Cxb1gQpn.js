import { _ as __nuxt_component_0 } from "./nuxt-link-CTV3v-lD.js";
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, toDisplayString, useSSRContext, computed, withAsyncContext, createTextVNode } from "vue";
  ...
  async setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: detail.value.article?.description?.slice(0, 160) ?? "Read this news article."
        },
        {
          property: "og:title",
...
//# sourceMappingURL=_id_-Cxb1gQpn.js.map
