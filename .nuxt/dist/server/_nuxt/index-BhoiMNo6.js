import { defineComponent, mergeProps, useSSRContext, ref, watch, computed, unref, withCtx, createVNode, withKeys, withModifiers, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, createTextVNode, withAsyncContext, isRef } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass } from "vue/server-renderer";
import { a as __nuxt_component_0, _ as _export_sfc, u as useRoute, b as useRouter, s as storeToRefs } from "../server.mjs";
...
import { _ as __nuxt_component_0$1 } from "./nuxt-link-CTV3v-lD.js";
import { u as useNewsStore } from "./news-CgqK9_x2.js";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/hookable/dist/index.mjs";
import { u as useHead } from "./v3-CGCe6pwf.js";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/klona/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/defu/dist/defu.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/ofetch/dist/node.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/unctx/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/h3/dist/index.mjs";
import "vue-router";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/ufo/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/destr/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/ohash/dist/index.mjs";
import "/Users/hastichavda/projects/web/News-Website-main/node_modules/@unhead/vue/dist/index.mjs";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(ListboxButton), { class: "flex items-center w-full px-3 py-2 text-sm text-left transition border rounded-lg border-border bg-surface text-on-surface hover:bg-muted/10 focus:outline-none focus:ring-2 focus:ring-primary" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="block min-w-0 truncate pr-8"${_scopeId2}>${ssrInterpolate(categories.find((c) => c.id === props.category)?.label ?? "All categories")}</span>`);
                  if (props.category) {
                  ...
                  return [
                    createVNode("span", { class: "block min-w-0 truncate pr-8" }, toDisplayString(categories.find((c) => c.id === props.category)?.label ?? "All categories"), 1),
            ...
            _push2(ssrRenderComponent(unref(ListboxButton), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span class="block min-w-0 truncate"${_scopeId2}>${ssrInterpolate(props.preset === "custom" ? unref(customPresetLabel) : presets.find((p) => p.id === props.preset)?.label ?? "Select Date")}</span></span>`);
                  ...
                  return [
                    createVNode("span", { class: "inline-flex min-w-0 items-center gap-2 pr-8" }, [
                      ...
                      createVNode("span", { class: "block min-w-0 truncate" }, toDisplayString(props.preset === "custom" ? unref(customPresetLabel) : presets.find((p) => p.id === props.preset)?.label ?? "Select Date"), 1)
                    ]),
              ...
              createVNode("div", { class: "flex flex-1 flex-col p-5" }, [
                createVNode("div", { class: "flex items-center justify-between gap-4" }, [
                  createVNode("div", { class: "flex items-center gap-2 text-xs text-muted" }, [
                    ...
                    unref(a).category?.[0] ? (openBlock(), createBlock("span", {
                      key: 1,
                      class: "rounded-full border border-border px-2 py-0.5"
                    ...
                    createVNode("div", { class: "flex flex-col justify-center flex-1" }, [
                      createVNode("div", { class: "flex flex-wrap items-center justify-between gap-2" }, [
                        createVNode("div", { class: "flex flex-wrap items-center gap-2 text-xs text-muted" }, [
                          ...
                          a.category?.[0] ? (openBlock(), createBlock("span", {
                            key: 1,
                            class: "rounded-full border border-border px-2 py-0.5 uppercase tracking-tight"
  ...
  async setup(__props) {
    ...
    async function applyFilters() {
      const query = {
        ...
        from: filters.value.preset === "custom" ? filters.value.from ?? void 0 : void 0,
        to: filters.value.preset === "custom" ? filters.value.to ?? void 0 : void 0
      };
      await router.push({
        path: "/news",
        query
...
//# sourceMappingURL=index-BhoiMNo6.js.map
