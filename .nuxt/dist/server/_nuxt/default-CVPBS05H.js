...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlotInner } from "vue/server-renderer";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "mt-10 border-t border-border bg-surface" }, _attrs))}><div class="py-6 container-wide sm:py-8"><p class="text-sm text-center text-muted"> © ${ssrInterpolate(unref(year))} News. Starter layout. </p></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=default-CVPBS05H.js.map
